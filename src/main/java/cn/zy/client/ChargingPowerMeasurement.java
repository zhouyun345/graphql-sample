 ...
 */
@GraphQLObjectType("ChargingPowerMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ChargingPowerMeasurement 
	...
	public ChargingPowerMeasurement(){
		// No action
	}

	@JsonProperty("kwt")
	@GraphQLNonScalar(fieldName = "kwt", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue kwt;
	...
	public void setKwt(FloatUnitMeasurementValue kwt) {
		this.kwt = kwt;
	}

	public FloatUnitMeasurementValue getKwt() {
		return kwt;
	}
    ...
    public String toString() {
        return "ChargingPowerMeasurement {"
				+ "kwt: " + kwt
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue kwt;
		private TranslatedText formattedInMarketplace;

		public Builder withKwt(FloatUnitMeasurementValue kwt) {
			this.kwt = kwt;
			return this;
		}
		...
		public ChargingPowerMeasurement build() {
			ChargingPowerMeasurement _object = new ChargingPowerMeasurement();
			_object.setKwt(kwt);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("ChargingPowerMeasurement");
			return _object;
		}
	}
}
