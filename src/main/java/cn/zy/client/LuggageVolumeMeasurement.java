 ...
 */
@GraphQLObjectType("LuggageVolumeMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class LuggageVolumeMeasurement 
	...
	public LuggageVolumeMeasurement(){
		// No action
	}

	@JsonProperty("ftq")
	@GraphQLNonScalar(fieldName = "ftq", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue ftq;
	...
	public void setFtq(FloatUnitMeasurementValue ftq) {
		this.ftq = ftq;
	}

	public FloatUnitMeasurementValue getFtq() {
		return ftq;
	}
    ...
    public String toString() {
        return "LuggageVolumeMeasurement {"
				+ "ftq: " + ftq
				+ ", "
				+ "ltr: " + ltr
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue ftq;
		private IntUnitMeasurementValue ltr;
		private TranslatedText formattedInMarketplace;

		public Builder withFtq(FloatUnitMeasurementValue ftq) {
			this.ftq = ftq;
			return this;
		}
		...
		public LuggageVolumeMeasurement build() {
			LuggageVolumeMeasurement _object = new LuggageVolumeMeasurement();
			_object.setFtq(ftq);
			_object.setLtr(ltr);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("LuggageVolumeMeasurement");
			return _object;
		}
	}
}
