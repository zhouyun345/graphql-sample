...
@JsonSubTypes({ @Type(value = FactoryVehicleInterior.class, name = "FactoryVehicleInterior"), @Type(value = VehicleStateInterior.class, name = "VehicleStateInterior") })
@GraphQLInterfaceType("Interior")
