 ...
 */
@GraphQLObjectType("SpeedMeasurement")
...
public class SpeedMeasurement 
	...
	@JsonProperty("hm")
	@GraphQLNonScalar(fieldName = "hm", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue hm;


	@JsonProperty("kmh")
	@GraphQLNonScalar(fieldName = "kmh", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue kmh;
	...
	public void setHm(IntUnitMeasurementValue hm) {
		this.hm = hm;
	}

	public IntUnitMeasurementValue getHm() {
		return hm;
	}
		

	public void setKmh(IntUnitMeasurementValue kmh) {
		this.kmh = kmh;
	}

	public IntUnitMeasurementValue getKmh() {
		return kmh;
	}
	...
	public static class Builder {
		private IntUnitMeasurementValue hm;
		private IntUnitMeasurementValue kmh;
		private TranslatedText formattedInMarketplace;

		public Builder withHm(IntUnitMeasurementValue hm) {
			this.hm = hm;
			return this;
		}
		public Builder withKmh(IntUnitMeasurementValue kmh) {
			this.kmh = kmh;
			return this;
		}
		...
		public SpeedMeasurement build() {
			SpeedMeasurement _object = new SpeedMeasurement();
			_object.setHm(hm);
			_object.setKmh(kmh);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("SpeedMeasurement");
			return _object;
		}
	}
}
