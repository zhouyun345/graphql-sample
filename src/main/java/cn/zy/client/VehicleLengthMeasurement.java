 ...
 */
@GraphQLObjectType("VehicleLengthMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class VehicleLengthMeasurement 
	...
	public VehicleLengthMeasurement(){
		// No action
	}
    ...
    public String toString() {
        return "VehicleLengthMeasurement {"
				+ "inh: " + inh
				+ ", "
				+ "mmtt: " + mmtt
				+ ", "
	...
	public static class Builder {
		...
		public VehicleLengthMeasurement build() {
			VehicleLengthMeasurement _object = new VehicleLengthMeasurement();
			_object.setInh(inh);
			_object.setMmtt(mmtt);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("VehicleLengthMeasurement");
			return _object;
		}
	}
}
