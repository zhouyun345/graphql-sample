 ...
 */
@GraphQLObjectType("VehicleWeightMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class VehicleWeightMeasurement 
	...
	public VehicleWeightMeasurement(){
		// No action
	}

	@JsonProperty("kgm")
	@GraphQLNonScalar(fieldName = "kgm", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue kgm;


	@JsonProperty("lbr")
	@GraphQLNonScalar(fieldName = "lbr", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue lbr;
	...
	public void setKgm(IntUnitMeasurementValue kgm) {
		this.kgm = kgm;
	}

	public IntUnitMeasurementValue getKgm() {
		return kgm;
	}
		

	public void setLbr(IntUnitMeasurementValue lbr) {
		this.lbr = lbr;
	}

	public IntUnitMeasurementValue getLbr() {
		return lbr;
	}
    ...
    public String toString() {
        return "VehicleWeightMeasurement {"
				+ "kgm: " + kgm
				+ ", "
				+ "lbr: " + lbr
				+ ", "
	...
	public static class Builder {
		private IntUnitMeasurementValue kgm;
		private IntUnitMeasurementValue lbr;
		private TranslatedText formattedInMarketplace;

		public Builder withKgm(IntUnitMeasurementValue kgm) {
			this.kgm = kgm;
			return this;
		}
		public Builder withLbr(IntUnitMeasurementValue lbr) {
			this.lbr = lbr;
			return this;
		}
		...
		public VehicleWeightMeasurement build() {
			VehicleWeightMeasurement _object = new VehicleWeightMeasurement();
			_object.setKgm(kgm);
			_object.setLbr(lbr);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("VehicleWeightMeasurement");
			return _object;
		}
	}
}
