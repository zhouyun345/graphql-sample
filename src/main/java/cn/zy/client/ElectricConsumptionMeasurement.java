 ...
 */
@GraphQLObjectType("ElectricConsumptionMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ElectricConsumptionMeasurement 
	...
	public ElectricConsumptionMeasurement(){
		// No action
	}

	@JsonProperty("vele")
	@GraphQLNonScalar(fieldName = "vele", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue vele;


	@JsonProperty("whrkmt")
	@GraphQLNonScalar(fieldName = "whrkmt", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue whrkmt;
	...
	public void setVele(FloatUnitMeasurementValue vele) {
		this.vele = vele;
	}

	public FloatUnitMeasurementValue getVele() {
		return vele;
	}
		

	public void setWhrkmt(FloatUnitMeasurementValue whrkmt) {
		this.whrkmt = whrkmt;
	}

	public FloatUnitMeasurementValue getWhrkmt() {
		return whrkmt;
	}
    ...
    public String toString() {
        return "ElectricConsumptionMeasurement {"
				+ "vele: " + vele
				+ ", "
				+ "whrkmt: " + whrkmt
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue vele;
		private FloatUnitMeasurementValue whrkmt;
		private TranslatedText formattedInMarketplace;

		public Builder withVele(FloatUnitMeasurementValue vele) {
			this.vele = vele;
			return this;
		}
		public Builder withWhrkmt(FloatUnitMeasurementValue whrkmt) {
			this.whrkmt = whrkmt;
			return this;
		}
		...
		public ElectricConsumptionMeasurement build() {
			ElectricConsumptionMeasurement _object = new ElectricConsumptionMeasurement();
			_object.setVele(vele);
			_object.setWhrkmt(whrkmt);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("ElectricConsumptionMeasurement");
			return _object;
		}
	}
}
