 ...
 */
@GraphQLObjectType("ModelGeneration")
...
public class ModelGeneration 
{
	...
	@GraphQLScalar(fieldName = "classic", graphQLTypeSimpleName = "Boolean", javaClass = Boolean.class)
	Boolean classic;
	...
	public static class Builder {
		...
		public Builder withClassic(Boolean classic) {
			this.classic = classic;
			return this;
		}
		...
		public ModelGeneration build() {
			ModelGeneration _object = new ModelGeneration();
			_object.setClassic(classic);
			_object.setKey(key);
			_object.setName(name);
			_object.set__typename("ModelGeneration");
			return _object;
		}
	}
}
