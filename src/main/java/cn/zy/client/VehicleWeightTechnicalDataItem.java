 ...
 */
@GraphQLObjectType("VehicleWeightTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class VehicleWeightTechnicalDataItem 
	...
	public VehicleWeightTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "VehicleWeightMeasurement", javaClass = VehicleWeightMeasurement.class)
	VehicleWeightMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof VehicleWeightMeasurement) {
			this.value = (VehicleWeightMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.VehicleWeightMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(VehicleWeightMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public VehicleWeightMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "VehicleWeightTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private VehicleWeightMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(VehicleWeightMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public VehicleWeightTechnicalDataItem build() {
			VehicleWeightTechnicalDataItem _object = new VehicleWeightTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("VehicleWeightTechnicalDataItem");
			return _object;
		}
	}
}
