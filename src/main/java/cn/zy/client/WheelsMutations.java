 ...
 */
@GraphQLObjectType("WheelsMutations")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class WheelsMutations 
{
	...
	public WheelsMutations(){
		// No action
	}

	@JsonProperty("manual")
	@GraphQLInputParameters(names = {"inventoryId", "wheels"}, types = {"String", "ManualWheelsModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	@GraphQLInputParameters(names = {"inventoryId", "wheels"}, types = {"String", "SelectedOptionCodeModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	public static class Builder {
		...
		public WheelsMutations build() {
			WheelsMutations _object = new WheelsMutations();
			_object.setManual(manual);
			_object.setSelected(selected);
			_object.set__typename("WheelsMutations");
			return _object;
		}
	}
}
