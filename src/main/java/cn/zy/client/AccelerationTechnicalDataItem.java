 ...
 */
@GraphQLObjectType("AccelerationTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class AccelerationTechnicalDataItem 
	...
	public AccelerationTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "AccelerationMeasurement", javaClass = AccelerationMeasurement.class)
	AccelerationMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof AccelerationMeasurement) {
			this.value = (AccelerationMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.AccelerationMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(AccelerationMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public AccelerationMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "AccelerationTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private AccelerationMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(AccelerationMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public AccelerationTechnicalDataItem build() {
			AccelerationTechnicalDataItem _object = new AccelerationTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("AccelerationTechnicalDataItem");
			return _object;
		}
	}
}
