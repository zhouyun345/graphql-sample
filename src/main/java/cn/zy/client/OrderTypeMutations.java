 ...
 */
@GraphQLObjectType("OrderTypeMutations")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class OrderTypeMutations 
{
	...
	public OrderTypeMutations(){
		// No action
	}

	@JsonProperty("manual")
	@GraphQLInputParameters(names = {"inventoryId", "orderType"}, types = {"String", "ManualOrderTypeModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	@GraphQLInputParameters(names = {"inventoryId", "orderType"}, types = {"String", "SelectedOrderTypeModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	public static class Builder {
		...
		public OrderTypeMutations build() {
			OrderTypeMutations _object = new OrderTypeMutations();
			_object.setManual(manual);
			_object.setSelected(selected);
			_object.set__typename("OrderTypeMutations");
			return _object;
		}
	}
}
