 ...
 */
@GraphQLObjectType("AngleTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class AngleTechnicalDataItem 
	...
	public AngleTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "AngleMeasurement", javaClass = AngleMeasurement.class)
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof AngleMeasurement) {
			this.value = (AngleMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.AngleMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(AngleMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public AngleMeasurement getValue() {
		return value;
	}
	...
	public static class Builder {
		private AngleMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(AngleMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public AngleTechnicalDataItem build() {
			AngleTechnicalDataItem _object = new AngleTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("AngleTechnicalDataItem");
			return _object;
		}
	}
}
