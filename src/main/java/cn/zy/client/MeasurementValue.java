...
@JsonSubTypes({ @Type(value = FloatUnitMeasurementValue.class, name = "FloatUnitMeasurementValue"), @Type(value = IntMeasurementValue.class, name = "IntMeasurementValue"), @Type(value = IntRangeUnitMeasurementValue.class, name = "IntRangeUnitMeasurementValue"), @Type(value = IntUnitMeasurementValue.class, name = "IntUnitMeasurementValue") })
@GraphQLInterfaceType("MeasurementValue")
