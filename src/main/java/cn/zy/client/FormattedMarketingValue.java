...
@JsonSubTypes({ @Type(value = AccelerationMeasurement.class, name = "AccelerationMeasurement"), @Type(value = AngleMeasurement.class, name = "AngleMeasurement"), @Type(value = BodyDetailLengthMeasurement.class, name = "BodyDetailLengthMeasurement"), @Type(value = ChargingPowerMeasurement.class, name = "ChargingPowerMeasurement"), @Type(value = ChargingTimeAcMeasurement.class, name = "ChargingTimeAcMeasurement"), @Type(value = ChargingTimeDcMeasurement.class, name = "ChargingTimeDcMeasurement"), @Type(value = DisplacementMeasurement.class, name = "DisplacementMeasurement"), @Type(value = DragMeasurement.class, name = "DragMeasurement"), @Type(value = ElectricCapacityMeasurement.class, name = "ElectricCapacityMeasurement"), @Type(value = ElectricConsumptionEquivalentMeasurement.class, name = "ElectricConsumptionEquivalentMeasurement"), @Type(value = ElectricConsumptionMeasurement.class, name = "ElectricConsumptionMeasurement"), @Type(value = EmissionMeasurement.class, name = "EmissionMeasurement"), @Type(value = EngineDetailLengthMeasurement.class, name = "EngineDetailLengthMeasurement"), @Type(value = FloatUnitMeasurementValue.class, name = "FloatUnitMeasurementValue"), @Type(value = FuelConsumptionMeasurement.class, name = "FuelConsumptionMeasurement"), @Type(value = FuelTankCapacityMeasurement.class, name = "FuelTankCapacityMeasurement"), @Type(value = IntMeasurementValue.class, name = "IntMeasurementValue"), @Type(value = IntRangeUnitMeasurementValue.class, name = "IntRangeUnitMeasurementValue"), @Type(value = IntUnitMeasurementValue.class, name = "IntUnitMeasurementValue"), @Type(value = LuggageVolumeMeasurement.class, name = "LuggageVolumeMeasurement"), @Type(value = MaxPowerPerLiter.class, name = "MaxPowerPerLiter"), @Type(value = PowerItem.class, name = "PowerItem"), @Type(value = RangeMeasurement.class, name = "RangeMeasurement"), @Type(value = RpmMeasurement.class, name = "RpmMeasurement"), @Type(value = RpmRangeMeasurement.class, name = "RpmRangeMeasurement"), @Type(value = SpeedMeasurement.class, name = "SpeedMeasurement"), @Type(value = TechnicalDataTranslatedEnumValue.class, name = "TechnicalDataTranslatedEnumValue"), @Type(value = TorqueMeasurement.class, name = "TorqueMeasurement"), @Type(value = TurningRadiusMeasurement.class, name = "TurningRadiusMeasurement"), @Type(value = VehicleLengthMeasurement.class, name = "VehicleLengthMeasurement"), @Type(value = VehicleWeightMeasurement.class, name = "VehicleWeightMeasurement") })
@GraphQLInterfaceType("FormattedMarketingValue")
@SuppressWarnings("unused")
public interface FormattedMarketingValue  {
