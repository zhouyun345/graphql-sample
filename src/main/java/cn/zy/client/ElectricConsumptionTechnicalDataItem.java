 ...
 */
@GraphQLObjectType("ElectricConsumptionTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ElectricConsumptionTechnicalDataItem 
	...
	public ElectricConsumptionTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "ElectricConsumptionMeasurement", javaClass = ElectricConsumptionMeasurement.class)
	ElectricConsumptionMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof ElectricConsumptionMeasurement) {
			this.value = (ElectricConsumptionMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.ElectricConsumptionMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(ElectricConsumptionMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public ElectricConsumptionMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "ElectricConsumptionTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private ElectricConsumptionMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(ElectricConsumptionMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public ElectricConsumptionTechnicalDataItem build() {
			ElectricConsumptionTechnicalDataItem _object = new ElectricConsumptionTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("ElectricConsumptionTechnicalDataItem");
			return _object;
		}
	}
}
