 ...
 */
@GraphQLObjectType("FloatUnitMeasurementValue")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class FloatUnitMeasurementValue 
	...
	public FloatUnitMeasurementValue(){
		// No action
	}

	@JsonProperty("precision")
	@GraphQLScalar(fieldName = "precision", graphQLTypeSimpleName = "Int", javaClass = Integer.class)
	Integer precision;
    ...
    public String toString() {
        return "FloatUnitMeasurementValue {"
				+ "precision: " + precision
				+ ", "
				+ "raw: " + raw
				+ ", "
	...
	public static class Builder {
		...
		public FloatUnitMeasurementValue build() {
			FloatUnitMeasurementValue _object = new FloatUnitMeasurementValue();
			_object.setPrecision(precision);
			_object.setRaw(raw);
			...
			_object.set__typename("FloatUnitMeasurementValue");
			return _object;
		}
	}
}
