 ...
 */
@GraphQLObjectType("MeasuredFloat")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class MeasuredFloat 
{
	...
	public static class Builder {
		...
		public MeasuredFloat build() {
			MeasuredFloat _object = new MeasuredFloat();
			_object.setFormattedWithUnit(formattedWithUnit);
			_object.setUnit(unit);
			_object.setFormatted(formatted);
			_object.setRaw(raw);
			_object.set__typename("MeasuredFloat");
			return _object;
		}
	}
}
