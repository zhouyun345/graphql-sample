 ...
 */
@GraphQLObjectType("DisplacementTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class DisplacementTechnicalDataItem 
	...
	public DisplacementTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "DisplacementMeasurement", javaClass = DisplacementMeasurement.class)
	DisplacementMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof DisplacementMeasurement) {
			this.value = (DisplacementMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.DisplacementMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(DisplacementMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public DisplacementMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "DisplacementTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private DisplacementMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(DisplacementMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public DisplacementTechnicalDataItem build() {
			DisplacementTechnicalDataItem _object = new DisplacementTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("DisplacementTechnicalDataItem");
			return _object;
		}
	}
}
