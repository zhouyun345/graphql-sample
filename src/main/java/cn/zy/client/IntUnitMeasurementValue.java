 ...
 */
@GraphQLObjectType("IntUnitMeasurementValue")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class IntUnitMeasurementValue 
	...
	public IntUnitMeasurementValue(){
		// No action
	}

	@JsonProperty("raw")
	@GraphQLScalar(fieldName = "raw", graphQLTypeSimpleName = "Int", javaClass = Integer.class)
	Integer raw;
    ...
    public String toString() {
        return "IntUnitMeasurementValue {"
				+ "raw: " + raw
				+ ", "
	...
	public static class Builder {
		...
		public Builder withRaw(Integer raw) {
			this.raw = raw;
			return this;
		}
		...
		public IntUnitMeasurementValue build() {
			IntUnitMeasurementValue _object = new IntUnitMeasurementValue();
			_object.setRaw(raw);
			...
			_object.set__typename("IntUnitMeasurementValue");
			return _object;
		}
	}
}
