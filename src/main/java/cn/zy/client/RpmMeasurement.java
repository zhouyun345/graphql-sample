 ...
 */
@GraphQLObjectType("RpmMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class RpmMeasurement 
	...
	public RpmMeasurement(){
		// No action
	}

	@JsonProperty("rpm")
	@GraphQLNonScalar(fieldName = "rpm", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue rpm;
	...
	public void setRpm(IntUnitMeasurementValue rpm) {
		this.rpm = rpm;
	}

	public IntUnitMeasurementValue getRpm() {
		return rpm;
	}
	...
	public static class Builder {
		private IntUnitMeasurementValue rpm;
		private TranslatedText formattedInMarketplace;

		public Builder withRpm(IntUnitMeasurementValue rpm) {
			this.rpm = rpm;
			return this;
		}
		...
		public RpmMeasurement build() {
			RpmMeasurement _object = new RpmMeasurement();
			_object.setRpm(rpm);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("RpmMeasurement");
			return _object;
		}
	}
}
