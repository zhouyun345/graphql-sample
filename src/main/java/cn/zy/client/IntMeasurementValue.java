 ...
 */
@GraphQLObjectType("IntMeasurementValue")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class IntMeasurementValue 
	implements MeasurementValue, FormattedMarketingValue{
	...
	public static class Builder {
		...
		public IntMeasurementValue build() {
			IntMeasurementValue _object = new IntMeasurementValue();
			_object.setRaw(raw);
			...
			_object.set__typename("IntMeasurementValue");
			return _object;
		}
	}
}
