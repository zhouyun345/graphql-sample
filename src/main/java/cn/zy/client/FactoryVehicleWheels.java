 ...
 */
@GraphQLObjectType("FactoryVehicleWheels")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class FactoryVehicleWheels 
	...
	public static class Builder {
		...
		public FactoryVehicleWheels build() {
			FactoryVehicleWheels _object = new FactoryVehicleWheels();
			...
			_object.set__typename("FactoryVehicleWheels");
			return _object;
		}
	}
}
