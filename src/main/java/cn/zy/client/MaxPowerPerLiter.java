 ...
 */
@GraphQLObjectType("MaxPowerPerLiter")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class MaxPowerPerLiter 
	...
	@JsonProperty("hpl")
	@GraphQLNonScalar(fieldName = "hpl", graphQLTypeSimpleName = "MaxPowerPerLiterWithDisclaimer", javaClass = MaxPowerPerLiterWithDisclaimer.class)
	MaxPowerPerLiterWithDisclaimer hpl;


	@JsonProperty("kwl")
	@GraphQLNonScalar(fieldName = "kwl", graphQLTypeSimpleName = "MaxPowerPerLiterWithDisclaimer", javaClass = MaxPowerPerLiterWithDisclaimer.class)
	MaxPowerPerLiterWithDisclaimer kwl;
	...
	@JsonProperty("psl")
	@GraphQLNonScalar(fieldName = "psl", graphQLTypeSimpleName = "MaxPowerPerLiterWithDisclaimer", javaClass = MaxPowerPerLiterWithDisclaimer.class)
	MaxPowerPerLiterWithDisclaimer psl;
	...
	public void setHpl(MaxPowerPerLiterWithDisclaimer hpl) {
		this.hpl = hpl;
	}

	public MaxPowerPerLiterWithDisclaimer getHpl() {
		return hpl;
	}
		

	public void setKwl(MaxPowerPerLiterWithDisclaimer kwl) {
		this.kwl = kwl;
	}

	public MaxPowerPerLiterWithDisclaimer getKwl() {
		return kwl;
	}
	...
	public void setPsl(MaxPowerPerLiterWithDisclaimer psl) {
		this.psl = psl;
	}

	public MaxPowerPerLiterWithDisclaimer getPsl() {
		return psl;
	}
	...
	public static class Builder {
		...
		private MaxPowerPerLiterWithDisclaimer hpl;
		private MaxPowerPerLiterWithDisclaimer kwl;
		private TranslatedText name;
		private MaxPowerPerLiterWithDisclaimer psl;
		...
		public Builder withHpl(MaxPowerPerLiterWithDisclaimer hpl) {
			this.hpl = hpl;
			return this;
		}
		public Builder withKwl(MaxPowerPerLiterWithDisclaimer kwl) {
			this.kwl = kwl;
			return this;
		}
		...
		public Builder withPsl(MaxPowerPerLiterWithDisclaimer psl) {
			this.psl = psl;
			return this;
		}

		public MaxPowerPerLiter build() {
			MaxPowerPerLiter _object = new MaxPowerPerLiter();
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.setHpl(hpl);
			_object.setKwl(kwl);
			_object.setName(name);
			_object.setPsl(psl);
			_object.set__typename("MaxPowerPerLiter");
			return _object;
		}
	}
}
