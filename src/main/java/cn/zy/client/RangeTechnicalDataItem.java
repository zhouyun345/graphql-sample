 ...
 */
@GraphQLObjectType("RangeTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class RangeTechnicalDataItem 
	...
	public RangeTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "RangeMeasurement", javaClass = RangeMeasurement.class)
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof RangeMeasurement) {
			this.value = (RangeMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.RangeMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(RangeMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public RangeMeasurement getValue() {
		return value;
	}
	...
	public static class Builder {
		private RangeMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(RangeMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public RangeTechnicalDataItem build() {
			RangeTechnicalDataItem _object = new RangeTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("RangeTechnicalDataItem");
			return _object;
		}
	}
}
