 ...
 */
@GraphQLObjectType("TurningRadiusMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class TurningRadiusMeasurement 
	...
	public TurningRadiusMeasurement(){
		// No action
	}

	@JsonProperty("fot")
	@GraphQLNonScalar(fieldName = "fot", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue fot;


	@JsonProperty("mtr")
	@GraphQLNonScalar(fieldName = "mtr", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue mtr;
	...
	public void setFot(FloatUnitMeasurementValue fot) {
		this.fot = fot;
	}

	public FloatUnitMeasurementValue getFot() {
		return fot;
	}
		

	public void setMtr(FloatUnitMeasurementValue mtr) {
		this.mtr = mtr;
	}

	public FloatUnitMeasurementValue getMtr() {
		return mtr;
	}
    ...
    public String toString() {
        return "TurningRadiusMeasurement {"
				+ "fot: " + fot
				+ ", "
				+ "mtr: " + mtr
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue fot;
		private FloatUnitMeasurementValue mtr;
		private TranslatedText formattedInMarketplace;

		public Builder withFot(FloatUnitMeasurementValue fot) {
			this.fot = fot;
			return this;
		}
		public Builder withMtr(FloatUnitMeasurementValue mtr) {
			this.mtr = mtr;
			return this;
		}
		...
		public TurningRadiusMeasurement build() {
			TurningRadiusMeasurement _object = new TurningRadiusMeasurement();
			_object.setFot(fot);
			_object.setMtr(mtr);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("TurningRadiusMeasurement");
			return _object;
		}
	}
}
