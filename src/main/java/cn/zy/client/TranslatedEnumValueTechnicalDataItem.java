 ...
 */
@GraphQLObjectType("TranslatedEnumValueTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class TranslatedEnumValueTechnicalDataItem 
	...
	public TranslatedEnumValueTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "TechnicalDataTranslatedEnumValue", javaClass = TechnicalDataTranslatedEnumValue.class)
	TechnicalDataTranslatedEnumValue value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof TechnicalDataTranslatedEnumValue) {
			this.value = (TechnicalDataTranslatedEnumValue) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.TechnicalDataTranslatedEnumValue, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(TechnicalDataTranslatedEnumValue value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public TechnicalDataTranslatedEnumValue getValue() {
		return value;
	}
    ...
    public String toString() {
        return "TranslatedEnumValueTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private TechnicalDataTranslatedEnumValue value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(TechnicalDataTranslatedEnumValue value) {
			this.value = value;
			return this;
		}
		...
		public TranslatedEnumValueTechnicalDataItem build() {
			TranslatedEnumValueTechnicalDataItem _object = new TranslatedEnumValueTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("TranslatedEnumValueTechnicalDataItem");
			return _object;
		}
	}
}
