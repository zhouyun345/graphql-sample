...
@JsonSubTypes({ @Type(value = FloatUnitMeasurementValue.class, name = "FloatUnitMeasurementValue"), @Type(value = IntRangeUnitMeasurementValue.class, name = "IntRangeUnitMeasurementValue"), @Type(value = IntUnitMeasurementValue.class, name = "IntUnitMeasurementValue") })
@GraphQLInterfaceType("UnitMeasurementValue")
@SuppressWarnings("unused")
public interface UnitMeasurementValue  {
