 ...
 */
@GraphQLObjectType("EquipmentTag")
...
public class EquipmentTag 
{
	...
	@GraphQLNonScalar(fieldName = "category", graphQLTypeSimpleName = "TranslatedEnumValue", javaClass = TranslatedEnumValue.class)
	TranslatedEnumValue category;
	...
	public void setCategory(TranslatedEnumValue category) {
		this.category = category;
	}

	public TranslatedEnumValue getCategory() {
		return category;
	}
	...
	public static class Builder {
		private TranslatedEnumValue category;
		private String key;
		private TranslatedText name;
		private Integer sortIndex;

		public Builder withCategory(TranslatedEnumValue category) {
			this.category = category;
			return this;
		}
		...
		public EquipmentTag build() {
			EquipmentTag _object = new EquipmentTag();
			_object.setCategory(category);
			_object.setKey(key);
			_object.setName(name);
			_object.setSortIndex(sortIndex);
			_object.set__typename("EquipmentTag");
			return _object;
		}
	}
}
