 ...
 */
@GraphQLObjectType("FuelConsumptionTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class FuelConsumptionTechnicalDataItem 
	...
	public FuelConsumptionTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "FuelConsumptionMeasurement", javaClass = FuelConsumptionMeasurement.class)
	FuelConsumptionMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof FuelConsumptionMeasurement) {
			this.value = (FuelConsumptionMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.FuelConsumptionMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(FuelConsumptionMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public FuelConsumptionMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "FuelConsumptionTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private FuelConsumptionMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(FuelConsumptionMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public FuelConsumptionTechnicalDataItem build() {
			FuelConsumptionTechnicalDataItem _object = new FuelConsumptionTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("FuelConsumptionTechnicalDataItem");
			return _object;
		}
	}
}
