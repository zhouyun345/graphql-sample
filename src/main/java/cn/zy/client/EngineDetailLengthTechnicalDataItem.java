 ...
 */
@GraphQLObjectType("EngineDetailLengthTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class EngineDetailLengthTechnicalDataItem 
	...
	public EngineDetailLengthTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "EngineDetailLengthMeasurement", javaClass = EngineDetailLengthMeasurement.class)
	EngineDetailLengthMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof EngineDetailLengthMeasurement) {
			this.value = (EngineDetailLengthMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.EngineDetailLengthMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(EngineDetailLengthMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public EngineDetailLengthMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "EngineDetailLengthTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private EngineDetailLengthMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(EngineDetailLengthMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public EngineDetailLengthTechnicalDataItem build() {
			EngineDetailLengthTechnicalDataItem _object = new EngineDetailLengthTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("EngineDetailLengthTechnicalDataItem");
			return _object;
		}
	}
}
