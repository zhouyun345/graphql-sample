 ...
 */
@GraphQLObjectType("BodyDetailLengthTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class BodyDetailLengthTechnicalDataItem 
	...
	public BodyDetailLengthTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "BodyDetailLengthMeasurement", javaClass = BodyDetailLengthMeasurement.class)
	BodyDetailLengthMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof BodyDetailLengthMeasurement) {
			this.value = (BodyDetailLengthMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.BodyDetailLengthMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(BodyDetailLengthMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public BodyDetailLengthMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "BodyDetailLengthTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private BodyDetailLengthMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(BodyDetailLengthMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public BodyDetailLengthTechnicalDataItem build() {
			BodyDetailLengthTechnicalDataItem _object = new BodyDetailLengthTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("BodyDetailLengthTechnicalDataItem");
			return _object;
		}
	}
}
