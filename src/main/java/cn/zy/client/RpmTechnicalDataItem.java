 ...
 */
@GraphQLObjectType("RpmTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class RpmTechnicalDataItem 
	...
	public RpmTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "RpmMeasurement", javaClass = RpmMeasurement.class)
	RpmMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof RpmMeasurement) {
			this.value = (RpmMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.RpmMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(RpmMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public RpmMeasurement getValue() {
		return value;
	}
	...
	public static class Builder {
		private RpmMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(RpmMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public RpmTechnicalDataItem build() {
			RpmTechnicalDataItem _object = new RpmTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("RpmTechnicalDataItem");
			return _object;
		}
	}
}
