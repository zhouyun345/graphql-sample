 ...
 */
@GraphQLObjectType("ElectricConsumptionEquivalentMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ElectricConsumptionEquivalentMeasurement 
	...
	public ElectricConsumptionEquivalentMeasurement(){
		// No action
	}

	@JsonProperty("mpge")
	@GraphQLNonScalar(fieldName = "mpge", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue mpge;
	...
	public void setMpge(FloatUnitMeasurementValue mpge) {
		this.mpge = mpge;
	}

	public FloatUnitMeasurementValue getMpge() {
		return mpge;
	}
    ...
    public String toString() {
        return "ElectricConsumptionEquivalentMeasurement {"
				+ "mpge: " + mpge
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue mpge;
		private TranslatedText formattedInMarketplace;

		public Builder withMpge(FloatUnitMeasurementValue mpge) {
			this.mpge = mpge;
			return this;
		}
		...
		public ElectricConsumptionEquivalentMeasurement build() {
			ElectricConsumptionEquivalentMeasurement _object = new ElectricConsumptionEquivalentMeasurement();
			_object.setMpge(mpge);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("ElectricConsumptionEquivalentMeasurement");
			return _object;
		}
	}
}
