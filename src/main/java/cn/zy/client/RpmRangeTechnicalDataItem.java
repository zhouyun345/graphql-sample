 ...
 */
@GraphQLObjectType("RpmRangeTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class RpmRangeTechnicalDataItem 
	...
	public RpmRangeTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "RpmRangeMeasurement", javaClass = RpmRangeMeasurement.class)
	RpmRangeMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof RpmRangeMeasurement) {
			this.value = (RpmRangeMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.RpmRangeMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(RpmRangeMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public RpmRangeMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "RpmRangeTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private RpmRangeMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(RpmRangeMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public RpmRangeTechnicalDataItem build() {
			RpmRangeTechnicalDataItem _object = new RpmRangeTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("RpmRangeTechnicalDataItem");
			return _object;
		}
	}
}
