 ...
 */
@GraphQLObjectType("EmissionTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class EmissionTechnicalDataItem 
	...
	public EmissionTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "EmissionMeasurement", javaClass = EmissionMeasurement.class)
	EmissionMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof EmissionMeasurement) {
			this.value = (EmissionMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.EmissionMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(EmissionMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public EmissionMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "EmissionTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private EmissionMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(EmissionMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public EmissionTechnicalDataItem build() {
			EmissionTechnicalDataItem _object = new EmissionTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("EmissionTechnicalDataItem");
			return _object;
		}
	}
}
