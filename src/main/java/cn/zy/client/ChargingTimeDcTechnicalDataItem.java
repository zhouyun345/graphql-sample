 ...
 */
@GraphQLObjectType("ChargingTimeDcTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ChargingTimeDcTechnicalDataItem 
	...
	public ChargingTimeDcTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "ChargingTimeDcMeasurement", javaClass = ChargingTimeDcMeasurement.class)
	ChargingTimeDcMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof ChargingTimeDcMeasurement) {
			this.value = (ChargingTimeDcMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.ChargingTimeDcMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(ChargingTimeDcMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public ChargingTimeDcMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "ChargingTimeDcTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private ChargingTimeDcMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(ChargingTimeDcMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public ChargingTimeDcTechnicalDataItem build() {
			ChargingTimeDcTechnicalDataItem _object = new ChargingTimeDcTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("ChargingTimeDcTechnicalDataItem");
			return _object;
		}
	}
}
