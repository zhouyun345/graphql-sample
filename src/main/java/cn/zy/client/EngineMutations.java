 ...
 */
@GraphQLObjectType("EngineMutations")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class EngineMutations 
{
	...
	public EngineMutations(){
		// No action
	}

	@JsonProperty("selected")
	@GraphQLInputParameters(names = {"inventoryId", "engine"}, types = {"String", "SelectedOptionCodeModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	public static class Builder {
		...
		public EngineMutations build() {
			EngineMutations _object = new EngineMutations();
			_object.setSelected(selected);
			_object.set__typename("EngineMutations");
			return _object;
		}
	}
}
