 ...
 */
@GraphQLObjectType("FuelTankCapacityMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class FuelTankCapacityMeasurement 
	...
	public FuelTankCapacityMeasurement(){
		// No action
	}

	@JsonProperty("gll")
	@GraphQLNonScalar(fieldName = "gll", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue gll;


	@JsonProperty("ltr")
	@GraphQLNonScalar(fieldName = "ltr", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue ltr;
	...
	public void setGll(FloatUnitMeasurementValue gll) {
		this.gll = gll;
	}

	public FloatUnitMeasurementValue getGll() {
		return gll;
	}
		

	public void setLtr(IntUnitMeasurementValue ltr) {
		this.ltr = ltr;
	}

	public IntUnitMeasurementValue getLtr() {
		return ltr;
	}
    ...
    public String toString() {
        return "FuelTankCapacityMeasurement {"
				+ "gll: " + gll
				+ ", "
				+ "ltr: " + ltr
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue gll;
		private IntUnitMeasurementValue ltr;
		private TranslatedText formattedInMarketplace;

		public Builder withGll(FloatUnitMeasurementValue gll) {
			this.gll = gll;
			return this;
		}
		public Builder withLtr(IntUnitMeasurementValue ltr) {
			this.ltr = ltr;
			return this;
		}
		...
		public FuelTankCapacityMeasurement build() {
			FuelTankCapacityMeasurement _object = new FuelTankCapacityMeasurement();
			_object.setGll(gll);
			_object.setLtr(ltr);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("FuelTankCapacityMeasurement");
			return _object;
		}
	}
}
