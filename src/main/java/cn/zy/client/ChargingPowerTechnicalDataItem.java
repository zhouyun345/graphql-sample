 ...
 */
@GraphQLObjectType("ChargingPowerTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ChargingPowerTechnicalDataItem 
	...
	public ChargingPowerTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "ChargingPowerMeasurement", javaClass = ChargingPowerMeasurement.class)
	ChargingPowerMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof ChargingPowerMeasurement) {
			this.value = (ChargingPowerMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.ChargingPowerMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(ChargingPowerMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public ChargingPowerMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "ChargingPowerTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private ChargingPowerMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(ChargingPowerMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public ChargingPowerTechnicalDataItem build() {
			ChargingPowerTechnicalDataItem _object = new ChargingPowerTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("ChargingPowerTechnicalDataItem");
			return _object;
		}
	}
}
