 ...
 */
@GraphQLObjectType("PorscheCodeServicePrice")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class PorscheCodeServicePrice 
{
	...
	public PorscheCodeServicePrice(){
		// No action
	}

	@JsonProperty("currency")
	@GraphQLScalar(fieldName = "currency", graphQLTypeSimpleName = "String", javaClass = String.class)
	String currency;
	...
	public static class Builder {
		...
		public PorscheCodeServicePrice build() {
			PorscheCodeServicePrice _object = new PorscheCodeServicePrice();
			_object.setCurrency(currency);
			_object.setFormattedWithUnit(formattedWithUnit);
			_object.setRaw(raw);
			_object.set__typename("PorscheCodeServicePrice");
			return _object;
		}
	}
}
