 ...
 */
@GraphQLObjectType("CustomerSpecifiedVehicle")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class CustomerSpecifiedVehicle 
{
	...
	public CustomerSpecifiedVehicle(){
		// No action
	}

	@JsonProperty("configuratorImages")
	@GraphQLNonScalar(fieldName = "configuratorImages", graphQLTypeSimpleName = "CustomerSpecifiedVehicleConfiguratorImages", javaClass = CustomerSpecifiedVehicleConfiguratorImages.class)
	CustomerSpecifiedVehicleConfiguratorImages configuratorImages;
	...
	@GraphQLNonScalar(fieldName = "metaData", graphQLTypeSimpleName = "CustomerSpecifiedVehicleMetaData", javaClass = CustomerSpecifiedVehicleMetaData.class)
	CustomerSpecifiedVehicleMetaData metaData;
	...
	@JsonProperty("modelYearCode")
	@GraphQLScalar(fieldName = "modelYearCode", graphQLTypeSimpleName = "String", javaClass = String.class)
	...
	@JsonProperty("porscheCodeServicePrice")
	@GraphQLNonScalar(fieldName = "porscheCodeServicePrice", graphQLTypeSimpleName = "PorscheCodeServicePrice", javaClass = PorscheCodeServicePrice.class)
	...
	@GraphQLNonScalar(fieldName = "salesArea", graphQLTypeSimpleName = "CSVSalesArea", javaClass = CSVSalesArea.class)
	CSVSalesArea salesArea;
	...
	public void setConfiguratorImages(CustomerSpecifiedVehicleConfiguratorImages configuratorImages) {
		this.configuratorImages = configuratorImages;
	}

	public CustomerSpecifiedVehicleConfiguratorImages getConfiguratorImages() {
	...
	public void setMetaData(CustomerSpecifiedVehicleMetaData metaData) {
		this.metaData = metaData;
	}

	public CustomerSpecifiedVehicleMetaData getMetaData() {
		return metaData;
	}
	...
	public void setPorscheCodeServicePrice(PorscheCodeServicePrice porscheCodeServicePrice) {
		this.porscheCodeServicePrice = porscheCodeServicePrice;
	}

	public PorscheCodeServicePrice getPorscheCodeServicePrice() {
		return porscheCodeServicePrice;
	}
	...
	public void setSalesArea(CSVSalesArea salesArea) {
		this.salesArea = salesArea;
	}

	public CSVSalesArea getSalesArea() {
		return salesArea;
	}
    ...
    public String toString() {
        return "CustomerSpecifiedVehicle {"
	...
	public static class Builder {
		private CustomerSpecifiedVehicleConfiguratorImages configuratorImages;
		...
		private CustomerSpecifiedVehicleMetaData metaData;
		...
		private PorscheCodeServicePrice porscheCodeServicePrice;
		private FactoryVehicleRoofColor roofColor;
		private CSVSalesArea salesArea;
		...
		public Builder withConfiguratorImages(CustomerSpecifiedVehicleConfiguratorImages configuratorImages) {
			this.configuratorImages = configuratorImages;
			return this;
		}
		...
		public Builder withMetaData(CustomerSpecifiedVehicleMetaData metaData) {
			this.metaData = metaData;
			return this;
		}
		...
		public Builder withModelYearCode(String modelYearCode) {
			this.modelYearCode = modelYearCode;
			return this;
		}
		...
		public Builder withPorscheCodeServicePrice(PorscheCodeServicePrice porscheCodeServicePrice) {
			this.porscheCodeServicePrice = porscheCodeServicePrice;
			return this;
		}
		...
		public Builder withSalesArea(CSVSalesArea salesArea) {
			this.salesArea = salesArea;
			return this;
		}
		...
		public CustomerSpecifiedVehicle build() {
			CustomerSpecifiedVehicle _object = new CustomerSpecifiedVehicle();
			...
			_object.set__typename("CustomerSpecifiedVehicle");
			return _object;
		}
	}
}
