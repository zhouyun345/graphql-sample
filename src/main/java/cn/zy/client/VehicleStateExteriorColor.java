 ...
 */
@GraphQLObjectType("VehicleStateExteriorColor")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class VehicleStateExteriorColor 
	...
	public VehicleStateExteriorColor(){
		// No action
	}
    ...
    public String toString() {
        return "VehicleStateExteriorColor {"
				+ "colorTag: " + colorTag
				+ ", "
	...
	public static class Builder {
		...
		public VehicleStateExteriorColor build() {
			VehicleStateExteriorColor _object = new VehicleStateExteriorColor();
			...
			_object.set__typename("VehicleStateExteriorColor");
			return _object;
		}
	}
}
