 ...
 */
@GraphQLObjectType("ChargingTimeAcMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ChargingTimeAcMeasurement 
	...
	public ChargingTimeAcMeasurement(){
		// No action
	}

	@JsonProperty("hour")
	@GraphQLNonScalar(fieldName = "hour", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue hour;
	...
	public void setHour(FloatUnitMeasurementValue hour) {
		this.hour = hour;
	}

	public FloatUnitMeasurementValue getHour() {
		return hour;
	}
    ...
    public String toString() {
        return "ChargingTimeAcMeasurement {"
				+ "hour: " + hour
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue hour;
		private TranslatedText formattedInMarketplace;

		public Builder withHour(FloatUnitMeasurementValue hour) {
			this.hour = hour;
			return this;
		}
		...
		public ChargingTimeAcMeasurement build() {
			ChargingTimeAcMeasurement _object = new ChargingTimeAcMeasurement();
			_object.setHour(hour);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("ChargingTimeAcMeasurement");
			return _object;
		}
	}
}
