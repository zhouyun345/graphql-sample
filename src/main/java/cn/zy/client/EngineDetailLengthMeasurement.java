 ...
 */
@GraphQLObjectType("EngineDetailLengthMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class EngineDetailLengthMeasurement 
	...
	public EngineDetailLengthMeasurement(){
		// No action
	}

	@JsonProperty("inh")
	@GraphQLNonScalar(fieldName = "inh", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue inh;


	@JsonProperty("mmtt")
	@GraphQLNonScalar(fieldName = "mmtt", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue mmtt;
	...
	public void setInh(FloatUnitMeasurementValue inh) {
		this.inh = inh;
	}

	public FloatUnitMeasurementValue getInh() {
		return inh;
	}
		

	public void setMmtt(FloatUnitMeasurementValue mmtt) {
		this.mmtt = mmtt;
	}

	public FloatUnitMeasurementValue getMmtt() {
		return mmtt;
	}
    ...
    public String toString() {
        return "EngineDetailLengthMeasurement {"
				+ "inh: " + inh
				+ ", "
				+ "mmtt: " + mmtt
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue inh;
		private FloatUnitMeasurementValue mmtt;
		private TranslatedText formattedInMarketplace;

		public Builder withInh(FloatUnitMeasurementValue inh) {
			this.inh = inh;
			return this;
		}
		public Builder withMmtt(FloatUnitMeasurementValue mmtt) {
			this.mmtt = mmtt;
			return this;
		}
		...
		public EngineDetailLengthMeasurement build() {
			EngineDetailLengthMeasurement _object = new EngineDetailLengthMeasurement();
			_object.setInh(inh);
			_object.setMmtt(mmtt);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("EngineDetailLengthMeasurement");
			return _object;
		}
	}
}
