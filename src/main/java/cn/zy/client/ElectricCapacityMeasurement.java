 ...
 */
@GraphQLObjectType("ElectricCapacityMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ElectricCapacityMeasurement 
	...
	public ElectricCapacityMeasurement(){
		// No action
	}

	@JsonProperty("kwh")
	@GraphQLNonScalar(fieldName = "kwh", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue kwh;
	...
	public void setKwh(FloatUnitMeasurementValue kwh) {
		this.kwh = kwh;
	}

	public FloatUnitMeasurementValue getKwh() {
		return kwh;
	}
    ...
    public String toString() {
        return "ElectricCapacityMeasurement {"
				+ "kwh: " + kwh
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue kwh;
		private TranslatedText formattedInMarketplace;

		public Builder withKwh(FloatUnitMeasurementValue kwh) {
			this.kwh = kwh;
			return this;
		}
		...
		public ElectricCapacityMeasurement build() {
			ElectricCapacityMeasurement _object = new ElectricCapacityMeasurement();
			_object.setKwh(kwh);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("ElectricCapacityMeasurement");
			return _object;
		}
	}
}
