 ...
 */
@GraphQLObjectType("TorqueTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class TorqueTechnicalDataItem 
	...
	public TorqueTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "TorqueMeasurement", javaClass = TorqueMeasurement.class)
	TorqueMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof TorqueMeasurement) {
			this.value = (TorqueMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.TorqueMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(TorqueMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public TorqueMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "TorqueTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private TorqueMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(TorqueMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public TorqueTechnicalDataItem build() {
			TorqueTechnicalDataItem _object = new TorqueTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("TorqueTechnicalDataItem");
			return _object;
		}
	}
}
