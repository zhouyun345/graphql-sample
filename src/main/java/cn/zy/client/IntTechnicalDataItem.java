 ...
 */
@GraphQLObjectType("IntTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class IntTechnicalDataItem 
	...
	public IntTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "IntMeasurementValue", javaClass = IntMeasurementValue.class)
	IntMeasurementValue value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof IntMeasurementValue) {
			this.value = (IntMeasurementValue) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.IntMeasurementValue, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(IntMeasurementValue value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public IntMeasurementValue getValue() {
		return value;
	}
	...
	public static class Builder {
		private IntMeasurementValue value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(IntMeasurementValue value) {
			this.value = value;
			return this;
		}
		...
		public IntTechnicalDataItem build() {
			IntTechnicalDataItem _object = new IntTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("IntTechnicalDataItem");
			return _object;
		}
	}
}
