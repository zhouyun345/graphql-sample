 ...
 */
@GraphQLObjectType("TurningRadiusTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class TurningRadiusTechnicalDataItem 
	...
	public TurningRadiusTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "TurningRadiusMeasurement", javaClass = TurningRadiusMeasurement.class)
	TurningRadiusMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof TurningRadiusMeasurement) {
			this.value = (TurningRadiusMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.TurningRadiusMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(TurningRadiusMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public TurningRadiusMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "TurningRadiusTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private TurningRadiusMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(TurningRadiusMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public TurningRadiusTechnicalDataItem build() {
			TurningRadiusTechnicalDataItem _object = new TurningRadiusTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("TurningRadiusTechnicalDataItem");
			return _object;
		}
	}
}
