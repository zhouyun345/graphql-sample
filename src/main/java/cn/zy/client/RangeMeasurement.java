 ...
 */
@GraphQLObjectType("RangeMeasurement")
...
public class RangeMeasurement 
	...
	public RangeMeasurement(){
		// No action
	}

	@JsonProperty("km")
	@GraphQLNonScalar(fieldName = "km", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue km;


	@JsonProperty("smi")
	@GraphQLNonScalar(fieldName = "smi", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue smi;
	...
	public void setKm(IntUnitMeasurementValue km) {
		this.km = km;
	}

	public IntUnitMeasurementValue getKm() {
		return km;
	}
		

	public void setSmi(IntUnitMeasurementValue smi) {
		this.smi = smi;
	}

	public IntUnitMeasurementValue getSmi() {
		return smi;
	}
	...
	public static class Builder {
		private IntUnitMeasurementValue km;
		private IntUnitMeasurementValue smi;
		private TranslatedText formattedInMarketplace;

		public Builder withKm(IntUnitMeasurementValue km) {
			this.km = km;
			return this;
		}
		public Builder withSmi(IntUnitMeasurementValue smi) {
			this.smi = smi;
			return this;
		}
		...
		public RangeMeasurement build() {
			RangeMeasurement _object = new RangeMeasurement();
			_object.setKm(km);
			_object.setSmi(smi);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("RangeMeasurement");
			return _object;
		}
	}
}
