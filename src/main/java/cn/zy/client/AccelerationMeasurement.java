 ...
 */
@GraphQLObjectType("AccelerationMeasurement")
...
public class AccelerationMeasurement 
	...
	@JsonProperty("sec")
	@GraphQLNonScalar(fieldName = "sec", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue sec;
	...
	public void setSec(FloatUnitMeasurementValue sec) {
		this.sec = sec;
	}

	public FloatUnitMeasurementValue getSec() {
		return sec;
	}
	...
	public static class Builder {
		private FloatUnitMeasurementValue sec;
		private TranslatedText formattedInMarketplace;

		public Builder withSec(FloatUnitMeasurementValue sec) {
			this.sec = sec;
			return this;
		}
		...
		public AccelerationMeasurement build() {
			AccelerationMeasurement _object = new AccelerationMeasurement();
			_object.setSec(sec);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("AccelerationMeasurement");
			return _object;
		}
	}
}
