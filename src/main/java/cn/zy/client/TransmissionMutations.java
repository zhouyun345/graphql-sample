 ...
 */
@GraphQLObjectType("TransmissionMutations")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class TransmissionMutations 
{
	...
	public TransmissionMutations(){
		// No action
	}

	@JsonProperty("manual")
	@GraphQLInputParameters(names = {"inventoryId", "transmission"}, types = {"String", "ManualTransmissionModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	@GraphQLInputParameters(names = {"inventoryId", "transmission"}, types = {"String", "SelectedOptionCodeModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	public static class Builder {
		...
		public TransmissionMutations build() {
			TransmissionMutations _object = new TransmissionMutations();
			_object.setManual(manual);
			_object.setSelected(selected);
			_object.set__typename("TransmissionMutations");
			return _object;
		}
	}
}
