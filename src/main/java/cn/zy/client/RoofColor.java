...
@JsonSubTypes({ @Type(value = FactoryVehicleRoofColor.class, name = "FactoryVehicleRoofColor"), @Type(value = VehicleStateRoofColor.class, name = "VehicleStateRoofColor") })
@GraphQLInterfaceType("RoofColor")
@SuppressWarnings("unused")
public interface RoofColor  {
