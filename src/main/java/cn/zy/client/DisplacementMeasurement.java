 ...
 */
@GraphQLObjectType("DisplacementMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class DisplacementMeasurement 
	...
	public DisplacementMeasurement(){
		// No action
	}

	@JsonProperty("cmq")
	@GraphQLNonScalar(fieldName = "cmq", graphQLTypeSimpleName = "IntUnitMeasurementValue", javaClass = IntUnitMeasurementValue.class)
	IntUnitMeasurementValue cmq;


	@JsonProperty("inq")
	@GraphQLNonScalar(fieldName = "inq", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue inq;


	@JsonProperty("ltr")
	@GraphQLNonScalar(fieldName = "ltr", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue ltr;
	...
	public void setCmq(IntUnitMeasurementValue cmq) {
		this.cmq = cmq;
	}

	public IntUnitMeasurementValue getCmq() {
		return cmq;
	}
		

	public void setInq(FloatUnitMeasurementValue inq) {
		this.inq = inq;
	}

	public FloatUnitMeasurementValue getInq() {
		return inq;
	}
		

	public void setLtr(FloatUnitMeasurementValue ltr) {
		this.ltr = ltr;
	}

	public FloatUnitMeasurementValue getLtr() {
		return ltr;
	}
	...
	public static class Builder {
		private IntUnitMeasurementValue cmq;
		private FloatUnitMeasurementValue inq;
		private FloatUnitMeasurementValue ltr;
		private TranslatedText formattedInMarketplace;

		public Builder withCmq(IntUnitMeasurementValue cmq) {
			this.cmq = cmq;
			return this;
		}
		public Builder withInq(FloatUnitMeasurementValue inq) {
			this.inq = inq;
			return this;
		}
		public Builder withLtr(FloatUnitMeasurementValue ltr) {
			this.ltr = ltr;
			return this;
		}
		...
		public DisplacementMeasurement build() {
			DisplacementMeasurement _object = new DisplacementMeasurement();
			_object.setCmq(cmq);
			_object.setInq(inq);
			_object.setLtr(ltr);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("DisplacementMeasurement");
			return _object;
		}
	}
}
