 ...
 */
@GraphQLObjectType("SpeedTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class SpeedTechnicalDataItem 
	...
	public SpeedTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "SpeedMeasurement", javaClass = SpeedMeasurement.class)
	SpeedMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof SpeedMeasurement) {
			this.value = (SpeedMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.SpeedMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(SpeedMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public SpeedMeasurement getValue() {
		return value;
	}
	...
	public static class Builder {
		private SpeedMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(SpeedMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public SpeedTechnicalDataItem build() {
			SpeedTechnicalDataItem _object = new SpeedTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("SpeedTechnicalDataItem");
			return _object;
		}
	}
}
