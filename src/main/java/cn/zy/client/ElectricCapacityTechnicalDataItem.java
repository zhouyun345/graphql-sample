 ...
 */
@GraphQLObjectType("ElectricCapacityTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ElectricCapacityTechnicalDataItem 
	...
	public ElectricCapacityTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "ElectricCapacityMeasurement", javaClass = ElectricCapacityMeasurement.class)
	ElectricCapacityMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof ElectricCapacityMeasurement) {
			this.value = (ElectricCapacityMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.ElectricCapacityMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(ElectricCapacityMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public ElectricCapacityMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "ElectricCapacityTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private ElectricCapacityMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(ElectricCapacityMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public ElectricCapacityTechnicalDataItem build() {
			ElectricCapacityTechnicalDataItem _object = new ElectricCapacityTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("ElectricCapacityTechnicalDataItem");
			return _object;
		}
	}
}
