 ...
 */
@GraphQLObjectType("DragMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class DragMeasurement 
	...
	public DragMeasurement(){
		// No action
	}

	@JsonProperty("cwval")
	@GraphQLNonScalar(fieldName = "cwval", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue cwval;
	...
	public void setCwval(FloatUnitMeasurementValue cwval) {
		this.cwval = cwval;
	}

	public FloatUnitMeasurementValue getCwval() {
		return cwval;
	}
	...
	public static class Builder {
		private FloatUnitMeasurementValue cwval;
		private TranslatedText formattedInMarketplace;

		public Builder withCwval(FloatUnitMeasurementValue cwval) {
			this.cwval = cwval;
			return this;
		}
		...
		public DragMeasurement build() {
			DragMeasurement _object = new DragMeasurement();
			_object.setCwval(cwval);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("DragMeasurement");
			return _object;
		}
	}
}
