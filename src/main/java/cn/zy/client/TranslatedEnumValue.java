 ...
 */
@GraphQLObjectType("TranslatedEnumValue")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class TranslatedEnumValue 
{
	...
	public static class Builder {
		...
		public TranslatedEnumValue build() {
			TranslatedEnumValue _object = new TranslatedEnumValue();
			_object.setKey(key);
			_object.setName(name);
			_object.set__typename("TranslatedEnumValue");
			return _object;
		}
	}
}
