 ...
 */
@GraphQLObjectType("ChargingTimeDcMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ChargingTimeDcMeasurement 
	...
	public ChargingTimeDcMeasurement(){
		// No action
	}

	@JsonProperty("min")
	@GraphQLNonScalar(fieldName = "min", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue min;
	...
	public void setMin(FloatUnitMeasurementValue min) {
		this.min = min;
	}

	public FloatUnitMeasurementValue getMin() {
		return min;
	}
    ...
    public String toString() {
        return "ChargingTimeDcMeasurement {"
				+ "min: " + min
				+ ", "
	...
	public static class Builder {
		private FloatUnitMeasurementValue min;
		private TranslatedText formattedInMarketplace;

		public Builder withMin(FloatUnitMeasurementValue min) {
			this.min = min;
			return this;
		}
		...
		public ChargingTimeDcMeasurement build() {
			ChargingTimeDcMeasurement _object = new ChargingTimeDcMeasurement();
			_object.setMin(min);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("ChargingTimeDcMeasurement");
			return _object;
		}
	}
}
