 ...
 */
@GraphQLInputType("FactoryVehicleEquipmentOptionsFilterInput")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class FactoryVehicleEquipmentOptionsFilterInput 
{
	...
	public FactoryVehicleEquipmentOptionsFilterInput(){
		// No action
	}
    ...
    public String toString() {
        return "FactoryVehicleEquipmentOptionsFilterInput {"
	...
	public static class Builder {
		...
		public FactoryVehicleEquipmentOptionsFilterInput build() {
			FactoryVehicleEquipmentOptionsFilterInput _object = new FactoryVehicleEquipmentOptionsFilterInput();
