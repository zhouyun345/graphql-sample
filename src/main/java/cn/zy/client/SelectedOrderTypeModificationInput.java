 ...
 */
@GraphQLInputType("SelectedOrderTypeModificationInput")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class SelectedOrderTypeModificationInput 
{
	...
	public SelectedOrderTypeModificationInput(){
		// No action
	}
    ...
    public String toString() {
        return "SelectedOrderTypeModificationInput {"
				+ "modelYear: " + modelYear
				+ ", "
	...
	public static class Builder {
		...
		public SelectedOrderTypeModificationInput build() {
			SelectedOrderTypeModificationInput _object = new SelectedOrderTypeModificationInput();
