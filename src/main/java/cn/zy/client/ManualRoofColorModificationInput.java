 ...
 */
@GraphQLInputType("ManualRoofColorModificationInput")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ManualRoofColorModificationInput 
{
	...
	public ManualRoofColorModificationInput(){
		// No action
	}
    ...
    public String toString() {
        return "ManualRoofColorModificationInput {"
	...
	public static class Builder {
		...
		public ManualRoofColorModificationInput build() {
			ManualRoofColorModificationInput _object = new ManualRoofColorModificationInput();
