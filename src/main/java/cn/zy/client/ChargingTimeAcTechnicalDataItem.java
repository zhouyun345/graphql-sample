 ...
 */
@GraphQLObjectType("ChargingTimeAcTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ChargingTimeAcTechnicalDataItem 
	...
	public ChargingTimeAcTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "ChargingTimeAcMeasurement", javaClass = ChargingTimeAcMeasurement.class)
	ChargingTimeAcMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof ChargingTimeAcMeasurement) {
			this.value = (ChargingTimeAcMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.ChargingTimeAcMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(ChargingTimeAcMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public ChargingTimeAcMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "ChargingTimeAcTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private ChargingTimeAcMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(ChargingTimeAcMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public ChargingTimeAcTechnicalDataItem build() {
			ChargingTimeAcTechnicalDataItem _object = new ChargingTimeAcTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("ChargingTimeAcTechnicalDataItem");
			return _object;
		}
	}
}
