 ...
 */
@GraphQLObjectType("VehicleStateEquipment")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class VehicleStateEquipment 
	...
	public static class Builder {
		...
		public VehicleStateEquipment build() {
			VehicleStateEquipment _object = new VehicleStateEquipment();
			...
			_object.set__typename("VehicleStateEquipment");
			return _object;
		}
	}
}
