 ...
 */
@GraphQLObjectType("InteriorMutations")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class InteriorMutations 
{
	...
	public InteriorMutations(){
		// No action
	}

	@JsonProperty("manual")
	@GraphQLInputParameters(names = {"inventoryId", "interior"}, types = {"String", "ManualInteriorModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	@GraphQLInputParameters(names = {"inventoryId", "interior"}, types = {"String", "SelectedOptionCodeModificationInput"}, mandatories = {true, true}, listDepths = {0, 0}, itemsMandatory = {false, false})
	...
	public static class Builder {
		...
		public InteriorMutations build() {
			InteriorMutations _object = new InteriorMutations();
			_object.setManual(manual);
			_object.setSelected(selected);
			_object.set__typename("InteriorMutations");
			return _object;
		}
	}
}
