 ...
 */
@GraphQLObjectType("FactoryVehicleRoofColor")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class FactoryVehicleRoofColor 
	...
	public FactoryVehicleRoofColor(){
		// No action
	}
    ...
    public String toString() {
        return "FactoryVehicleRoofColor {"
	...
	public static class Builder {
		...
		public FactoryVehicleRoofColor build() {
			FactoryVehicleRoofColor _object = new FactoryVehicleRoofColor();
			...
			_object.set__typename("FactoryVehicleRoofColor");
			return _object;
		}
	}
}
