 ...
 */
@GraphQLObjectType("AngleMeasurement")
...
public class AngleMeasurement 
	...
	@JsonProperty("degree")
	@GraphQLNonScalar(fieldName = "degree", graphQLTypeSimpleName = "FloatUnitMeasurementValue", javaClass = FloatUnitMeasurementValue.class)
	FloatUnitMeasurementValue degree;
	...
	public void setDegree(FloatUnitMeasurementValue degree) {
		this.degree = degree;
	}

	public FloatUnitMeasurementValue getDegree() {
		return degree;
	}
	...
	public static class Builder {
		private FloatUnitMeasurementValue degree;
		private TranslatedText formattedInMarketplace;

		public Builder withDegree(FloatUnitMeasurementValue degree) {
			this.degree = degree;
			return this;
		}
		...
		public AngleMeasurement build() {
			AngleMeasurement _object = new AngleMeasurement();
			_object.setDegree(degree);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("AngleMeasurement");
			return _object;
		}
	}
}
