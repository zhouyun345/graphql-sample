 ...
 */
@GraphQLObjectType("LuggageVolumeTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class LuggageVolumeTechnicalDataItem 
	...
	public LuggageVolumeTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "LuggageVolumeMeasurement", javaClass = LuggageVolumeMeasurement.class)
	LuggageVolumeMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof LuggageVolumeMeasurement) {
			this.value = (LuggageVolumeMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.LuggageVolumeMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(LuggageVolumeMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public LuggageVolumeMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "LuggageVolumeTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private LuggageVolumeMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(LuggageVolumeMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public LuggageVolumeTechnicalDataItem build() {
			LuggageVolumeTechnicalDataItem _object = new LuggageVolumeTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("LuggageVolumeTechnicalDataItem");
			return _object;
		}
	}
}
