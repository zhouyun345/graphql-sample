 ...
 */
@GraphQLObjectType("ElectricConsumptionEquivalentTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class ElectricConsumptionEquivalentTechnicalDataItem 
	...
	public ElectricConsumptionEquivalentTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "ElectricConsumptionEquivalentMeasurement", javaClass = ElectricConsumptionEquivalentMeasurement.class)
	ElectricConsumptionEquivalentMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof ElectricConsumptionEquivalentMeasurement) {
			this.value = (ElectricConsumptionEquivalentMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.ElectricConsumptionEquivalentMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(ElectricConsumptionEquivalentMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public ElectricConsumptionEquivalentMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "ElectricConsumptionEquivalentTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private ElectricConsumptionEquivalentMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(ElectricConsumptionEquivalentMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public ElectricConsumptionEquivalentTechnicalDataItem build() {
			ElectricConsumptionEquivalentTechnicalDataItem _object = new ElectricConsumptionEquivalentTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("ElectricConsumptionEquivalentTechnicalDataItem");
			return _object;
		}
	}
}
