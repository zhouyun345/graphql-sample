...
@JsonSubTypes({ @Type(value = FactoryVehicleWheels.class, name = "FactoryVehicleWheels"), @Type(value = VehicleStateWheels.class, name = "VehicleStateWheels") })
@GraphQLInterfaceType("Wheels")
