 ...
 */
@GraphQLObjectType("VehicleLengthTechnicalDataItem")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class VehicleLengthTechnicalDataItem 
	...
	public VehicleLengthTechnicalDataItem(){
		// No action
	}

	@JsonProperty("value")
	@GraphQLNonScalar(fieldName = "value", graphQLTypeSimpleName = "VehicleLengthMeasurement", javaClass = VehicleLengthMeasurement.class)
	VehicleLengthMeasurement value;
	...
	public void setValue(FormattedMarketingValue value) {
		if (value == null || value instanceof VehicleLengthMeasurement) {
			this.value = (VehicleLengthMeasurement) value;
		} else {
			throw new IllegalArgumentException("The given value should be an instance of cn.zy.client.VehicleLengthMeasurement, but is an instance of "
	 ...
	 * @param
	 */
	public void setValue(VehicleLengthMeasurement value) {
		this.value = value;
	}
	 ...
	 */
	@Override
	public VehicleLengthMeasurement getValue() {
		return value;
	}
    ...
    public String toString() {
        return "VehicleLengthTechnicalDataItem {"
				+ "value: " + value
				+ ", "
	...
	public static class Builder {
		private VehicleLengthMeasurement value;
		private TranslatedText disclaimer;
		private TranslatedText name;

		public Builder withValue(VehicleLengthMeasurement value) {
			this.value = value;
			return this;
		}
		...
		public VehicleLengthTechnicalDataItem build() {
			VehicleLengthTechnicalDataItem _object = new VehicleLengthTechnicalDataItem();
			_object.setValue(value);
			_object.setDisclaimer(disclaimer);
			_object.setName(name);
			_object.set__typename("VehicleLengthTechnicalDataItem");
			return _object;
		}
	}
}
