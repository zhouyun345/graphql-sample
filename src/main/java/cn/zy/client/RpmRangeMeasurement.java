 ...
 */
@GraphQLObjectType("RpmRangeMeasurement")
@JsonInclude(Include.NON_NULL)
@SuppressWarnings("unused")
public class RpmRangeMeasurement 
	...
	public RpmRangeMeasurement(){
		// No action
	}

	@JsonProperty("rpm")
	@GraphQLNonScalar(fieldName = "rpm", graphQLTypeSimpleName = "IntRangeUnitMeasurementValue", javaClass = IntRangeUnitMeasurementValue.class)
	IntRangeUnitMeasurementValue rpm;
	...
	public void setRpm(IntRangeUnitMeasurementValue rpm) {
		this.rpm = rpm;
	}

	public IntRangeUnitMeasurementValue getRpm() {
		return rpm;
	}
	...
	public static class Builder {
		private IntRangeUnitMeasurementValue rpm;
		private TranslatedText formattedInMarketplace;

		public Builder withRpm(IntRangeUnitMeasurementValue rpm) {
			this.rpm = rpm;
			return this;
		}
		...
		public RpmRangeMeasurement build() {
			RpmRangeMeasurement _object = new RpmRangeMeasurement();
			_object.setRpm(rpm);
			_object.setFormattedInMarketplace(formattedInMarketplace);
			_object.set__typename("RpmRangeMeasurement");
			return _object;
		}
	}
}
